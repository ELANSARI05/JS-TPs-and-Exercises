      ...
      <div class="signin-signup">
        <form @submit.prevent="login" class="sign-in-form">
          ...
          <div class="social-media">
            ...
            <a @click="signInWithGoogle" class="social-icon">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <router-link to="/register"><button class="btn transparent" id="sign-up-btn">Sign Up</button></router-link>
        </div>
        <img src="https://raw.githubusercontent.com/JunaidShamnad/SignIn-SignUp-Form/cb95d902670fd1bac786ecf58be1810cc75c3ca8/img/log.svg" class="image" alt="">
      </div>
      <div class="panel right-panel">
        ...
        <img src="https://raw.githubusercontent.com/JunaidShamnad/SignIn-SignUp-Form/cb95d902670fd1bac786ecf58be1810cc75c3ca8/img/register.svg" class="image" alt="">
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async signInWithFacebook() {
      try {
        ...
        this.error = "Error signing in with Facebook. Please try again.";
